...
function create() {
    return __awaiter(this, void 0, void 0, function () {
        var waPage, authenticated;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    spinner.start('Initializing whatsapp');
                    return [4, browser_1.initWhatsapp()];
                case 1:
                    waPage = _a.sent();
                    spinner.succeed();
                ...
                case 2:
                    ...
                    if (!authenticated) return [3, 3];
                    spinner.succeed();
                    return [3, 6];
                case 3:
                    spinner.info('Authenticate to continue');
                    return [4, auth_1.retrieveQR(waPage)];
                case 4:
                    _a.sent();
                    return [4, auth_1.isInsideChat(waPage).toPromise()];
                case 5:
                    _a.sent();
                    spinner.succeed();
                    _a.label = 6;
