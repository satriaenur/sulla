...
function initWhatsapp() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, initBrowser()];
                case 1:
                    browser = _a.sent();
                    return [4, getWhatsappPage(browser)];
                case 2:
                    waPage = _a.sent();
                    return [4, waPage.setUserAgent('Mozilla/5.0 (Macintosh; Intel Mac OS X 10_12_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/65.0.3312.0 Safari/537.36')];
                case 3:
                    _a.sent();
                    return [4, waPage.goto(puppeteer_config_1.puppeteerConfig.whatsappUrl)];
                case 4:
                    _a.sent();
                    return [2, waPage];
            }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, puppeteer_1.default.launch({
                        ...
                        args: puppeteer_config_1.puppeteerConfig.chroniumArgs.slice()
                    })];
                case 1:
                    browser = _a.sent();
                    return [2, browser];
